...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Milan Students Network" },
      {
        name: "description",
        content: "A warm community for international students moving to and living in Milan.",
      },
      { name: "author", content: "Milan Students Network" },
      { property: "og:title", content: "Milan Students Network" },
      {
